package a2_bi10_118.studentman;
import utils.*;
import java.util.*;
import java.math.*;
...
public class PostgradStudent extends Student {
     ...
     *
     */
    public PostgradStudent(@AttrRef("id") int id,@AttrRef("name") String name, @AttrRef("phoneNumber") String phoneNumber, @AttrRef("address") String address, @AttrRef("gpa") float gpa) throws NotPossibleException {
        super(id,name,phoneNumber,address);
        if(!validateGpa(gpa)) {
            throw new NotPossibleException("PostgradStudent.init: invalid gpa");
        }
        this.gpa = gpa;
    }
     ...
     *      set this.gpa = gpa
     */
    public boolean setGpa(int gpa) throws Exception {
        if (validateGpa(gpa)) {
            this.gpa = gpa;
            return true;
        }
